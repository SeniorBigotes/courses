...
const { crearUsuario, obtenerUsuarios, obtenerUsuarioPorId, obtenerUsuarioPorUsername, actualizarUsuario, eliminarUsuario, buscarUsuarios } = require('../controladores/controladorUsuarios');

// Rutas para usuarios
router.post('/', crearUsuario); // Crear un nuevo usuario
router.get('/busqueda/:buscar', buscarUsuarios)
